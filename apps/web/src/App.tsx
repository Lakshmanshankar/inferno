...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@inferno/ui/components/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@inferno/ui/components/tabs";
import { Typography } from "@inferno/ui/components/typography";

const USAGE_CODE = `import { Button } from "@inferno/ui/components/button";
		...
		<div className="min-h-screen bg-gray-50 p-4">
			<div className="container mx-auto py-8 px-4">
				<header className="text-center mb-12">
					<Typography.Large>Turborepo UI Starter</Typography.Large>
					<Typography.Lead>
						A minimalistic monorepo setup with shared UI components from the{" "}
						<code className="bg-gray-100 px-1 py-0.5 rounded">@inferno/ui</code> package.
					</Typography.Lead>
				</header>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<Card>
								...
								<CardFooter className="text-sm text-gray-500">
									Import from: <code>@inferno/ui/components/button</code>
								</CardFooter>
							</Card>
							...
							<Card>
								...
								<CardContent>
									<p className="text-sm">
										Cards provide a flexible container for displaying content with a consistent
										style. They include CardHeader, CardTitle, CardDescription, CardContent, and
										CardFooter.
									</p>
								</CardContent>
								<CardFooter className="text-sm text-gray-500">
									Import from: <code>@inferno/ui/components/card</code>
								</CardFooter>
							</Card>
						</div>
					</TabsContent>
						...
						<Card>
							...
							<CardContent>
								<ul className="list-disc pl-5 space-y-2">
									<li>
										<strong>React 19</strong> - Latest version of React with improved performance
									</li>
									<li>
										<strong>TypeScript</strong> - For type safety and better developer experience
									</li>
									<li>
										<strong>Vite</strong> - Fast, modern frontend build tool
									</li>
									<li>
										<strong>TailwindCSS</strong> - Utility-first CSS framework
									</li>
									<li>
										<strong>Radix UI</strong> - Unstyled, accessible UI components
									</li>
									<li>
										<strong>Framer Motion</strong> - Animation library for React
									</li>
									<li>
										<strong>Turborepo</strong> - Monorepo build system for JavaScript/TypeScript
									</li>
									<li>
