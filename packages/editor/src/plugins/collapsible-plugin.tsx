...
} from '../nodes/collapsible/CollapsibleContainerNode.tsx'
import {
  $createCollapsibleContentNode,
  $isCollapsibleContentNode,
  CollapsibleContentNode,
} from '../nodes/collapsible/CollapsibleContentNode.tsx'
import {
  $createCollapsibleTitleNode,
  $isCollapsibleTitleNode,
  CollapsibleTitleNode,
} from '../nodes/collapsible/CollapsibleTitleNode.tsx'
...
export function CollapsiblePlugin(): null {
  ...
  useEffect(() => {
    if (
      ...
      throw new Error(
        'CollapsiblePlugin: CollapsibleContainerNode.tsx, CollapsibleTitleNode, or CollapsibleContentNode not registered on editor'
      )
    }
    ...
    return mergeRegister(
      ...
      editor.registerCommand(
        ...
        () => {
          console.log('INSERT_COLLAPSIBLE_COMMAND')
          editor.update(() => {
